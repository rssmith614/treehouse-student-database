            ...
            <div className='d-flex flex-row m-1' key={i}>
              <div className='m-2 d-flex flex-column align-items-center'>
                <button
                  ...
                  type='button'
                  onClick={() => {
                    removeEContact(params.list.indexOf(contact));
                  }}
                  class='form-control btn btn-danger flex-fill'
                >
                  🗑️
                </button>
              </div>
              <div className='m-2'>
                <label for={rowid + "name"} class='form-label'>
                  Name
                </label>
                <input
                  type='text'
              ...
              <div className='m-2'>
                <label for={rowid + "rel"} class='form-label'>
                  Relation
                </label>
                <input
                  type='text'
              ...
              <div className='m-2'>
                <label for={rowid + "phone"} class='form-label'>
                  Phone
                </label>
                <input
                  type='tel'
